	...
	<form action="add.php" method="POST" role="form" enctype="multipart/form-data" style="border: 1px solid red; width: 350px;">
		...
		<?php  
			...
			if (isset($_POST["submit"])){
				...
				$connect = new mysqli("localhost","root","", "db2") or die ("khong the ket not");
				...
				if ($connect->query($sql)) {
					echo "<img src = 'img/$file_part' width = '100px' height = '100px'/>".$name."&ensp;".$price."&ensp;".$quatity."&ensp;".$id."<br>";
